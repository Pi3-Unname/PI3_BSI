...
st.write(data.groupby(['APR Severity of Illness Description', 'APR Severity of Illness Code']).size().reset_index(name='Total'))

""" data2=pd.read_parquet('venv\project\data\hospital.parquet')
st.write([data['Facility Name'].unique()]) """
